											...
											<%int nullCount = 0;
											  String hasFile = "";
												...
												if(!isAllFileNull && hasFile != null) { %>
													<td style="text-align: center;"><img onmouseover="bigImg(this)" onmouseout="normalImg(this)" border="0" alt="img" src="/itemImage/upload/<%=hasFile%>" width="90px;" height="65px;"></td>
												<%} else { %>
